...
import 'admin_inspection_model.dart';
export 'admin_inspection_model.dart';

class AdminInspectionWidget extends StatefulWidget {
  const AdminInspectionWidget({super.key});

  @override
  State<AdminInspectionWidget> createState() => _AdminInspectionWidgetState();
}

class _AdminInspectionWidgetState extends State<AdminInspectionWidget> {
  late AdminInspectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminInspectionModel());
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  context.goNamed('Inspectionpage');
                },
              ),
            ),
          ],
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  StreamBuilder<List<PGTstationCodeRecord>>(
                                    stream: queryPGTstationCodeRecord(
                                      queryBuilder: (pGTstationCodeRecord) =>
                                          pGTstationCodeRecord.where(Filter.or(
                                        Filter(
                                          'Station',
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<PGTstationCodeRecord>
                                          dropDownPGTstationCodeRecordList =
                                          snapshot.data!;
