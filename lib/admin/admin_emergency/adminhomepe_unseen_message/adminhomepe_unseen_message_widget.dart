...
import 'adminhomepe_unseen_message_model.dart';
export 'adminhomepe_unseen_message_model.dart';

class AdminhomepeUnseenMessageWidget extends StatefulWidget {
  const AdminhomepeUnseenMessageWidget({super.key});

  @override
  State<AdminhomepeUnseenMessageWidget> createState() =>
      _AdminhomepeUnseenMessageWidgetState();
}

class _AdminhomepeUnseenMessageWidgetState
    extends State<AdminhomepeUnseenMessageWidget> {
  late AdminhomepeUnseenMessageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminhomepeUnseenMessageModel());
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 0.0, 25.0),
                      child: RichText(
