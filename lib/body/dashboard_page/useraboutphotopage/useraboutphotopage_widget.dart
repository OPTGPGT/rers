...
import 'useraboutphotopage_model.dart';
export 'useraboutphotopage_model.dart';

class UseraboutphotopageWidget extends StatefulWidget {
  const UseraboutphotopageWidget({
    super.key,
    required this.title,
    required this.shortdis,
  ...
  @override
  State<UseraboutphotopageWidget> createState() =>
      _UseraboutphotopageWidgetState();
}

class _UseraboutphotopageWidgetState extends State<UseraboutphotopageWidget> {
  late UseraboutphotopageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UseraboutphotopageModel());
