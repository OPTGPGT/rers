...
import 'usercomplaints_model.dart';
export 'usercomplaints_model.dart';
...
class _UsercomplaintsWidgetState extends State<UsercomplaintsWidget>
  ...
  void initState() {
    ...
    _model.remarksFocusNode!.addListener(() => safeSetState(() {}));
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor:
                                          (_model.remarksFocusNode?.hasFocus ??
                                                  false)
                                              ? const Color(0x4D9489F5)
                                              : Colors.white,
                                      contentPadding:
                                            ...
                                            builder: (context) {
                                              ...
                                              return ListView.separated(
                                                ...
                                                scrollDirection:
                                                    Axis.horizontal,
                                                itemCount:
                                                    complaitsphotogalary.length,
                                                separatorBuilder: (_, __) =>
                                                    const SizedBox(width: 12.0),
                                                itemBuilder: (context,
                                                    complaitsphotogalaryIndex) {
                                                  final complaitsphotogalaryItem =
                                                      complaitsphotogalary[
                                                          complaitsphotogalaryIndex];
                                                  return InkWell(
                                                    splashColor:
                                                        Colors.transparent,
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await UserComplaintsRecord.collection.doc().set({
                          ...createUserComplaintsRecordData(
                            userid: currentUserReference,
                            stationName: _model.stationDropdownValue,
                            dateTime: getCurrentTimestamp,
                            desscription: _model.descriptionTextController.text,
                            remarks: _model.remarksTextController.text,
                            serName: currentUserDisplayName,
                            userMail: currentUserEmail,
                          ),
                          ...mapToFirestore(
                            {
                              'complaintsimage': _model.uploadedFileUrls,
                            },
                          ),
                        });
